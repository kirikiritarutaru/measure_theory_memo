...
---
# Q. ルベーグ外測度を使って、$\mathbb{R}$のすべての部分集合を測ることはできるか？

---
# A. できないことが知られている
よって、$\mathbb{R}$の部分集合全体の集合を対象にするのではなく**適切に**制限した部分集合を「測る」対象にする

---
# ルベーグ可測集合
次の条件を満たす$\mathbb{R}^k$の部分集合$E$をルベーグ可測集合（または、単に可測集合）という。
